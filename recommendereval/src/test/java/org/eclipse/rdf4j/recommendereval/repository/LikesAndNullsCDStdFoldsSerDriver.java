...
import org.eclipse.rdf4j.recommendereval.evaluator.crosskfold.StdFoldsLikesAndNullsEvalStub;
 ...
 */
public class LikesAndNullsCDStdFoldsSerDriver extends SailRecEvaluatorRepository {
     ...
     */
    public LikesAndNullsCDStdFoldsSerDriver(Sail sail) {
     ...
     * StdFoldsLikesAndNullsEvalStub, that creates a SrrLikesAndNullsDriver,
    ...
    public void loadEvalConfiguration(EvalConfig evalConfig)
        ...
        if (success) {
            ...
            if( evalConfig instanceof CrossKFoldEvalConfig ) {
                evaluator = new StdFoldsLikesAndNullsEvalStub(this);
            }
            else {
     ...
     * and the local one have to be therefore used.
     * 
     * @throws EvaluatorException
     */
    @Override

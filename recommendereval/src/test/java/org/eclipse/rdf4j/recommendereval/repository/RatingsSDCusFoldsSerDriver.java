...
import org.eclipse.rdf4j.recommendereval.evaluator.crosskfold.CusFoldsRatingsEvalStub;
 ...
 * @org.eclipse.rdf4j.recommender.repository.SrrRatingsDriver.
 * 
 * This evaluator should be only used for test purposes.
 */
public class RatingsSDCusFoldsSerDriver extends SailRecEvaluatorRepository {
     ...
     */
    public RatingsSDCusFoldsSerDriver(Sail sail) {
     ...
     * CusFoldsRatingsEvalStub, that creates a SrrRatingsDriver,
    ...
    public void loadEvalConfiguration(EvalConfig evalConfig)
        ...
        if (success) {
            ...
            if( evalConfig instanceof CrossKFoldEvalConfig ) {
                evaluator = new CusFoldsRatingsEvalStub(this);
            }
            else {

 ...
 * based on the "fixed-ratings.ttl" dataset. Top-k recommendations might be
 * null.
 */
public class RatingsAndNullsSrrDriver extends SailRecommenderRepository {         
	 ...
	 *        A Sail object.
	 */
	public RatingsAndNullsSrrDriver(Sail sail) {
		super(sail);
	}
	 ...
	 *---------*/      
        ...
        public RatedResource[] getTop3RecommendationsWithNulls(String userURI) throws RecommenderException {
                ...
                if (userURI.equals("http://example.org/fixed#User1")){
                        ...
                        res3 = new RatedResource("http://example.org/fixed#Item6", 5.0);
                }
                ...
                if (userURI.equals("http://example.org/fixed#User3")){
                        ...
                        res2 = null;
                        res3 = new RatedResource("http://example.org/fixed#Item5", 5.0);
                }
                //Precision 0
                if (userURI.equals("http://example.org/fixed#User4")){

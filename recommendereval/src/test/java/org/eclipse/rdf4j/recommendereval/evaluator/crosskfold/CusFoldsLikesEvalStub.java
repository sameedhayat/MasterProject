 ...
 */
public class CusFoldsLikesEvalStub extends CrossKFoldEvaluator {

    final static Logger LOGGER = Logger.getLogger(CusFoldsLikesEvalStub.class);
    
    public CusFoldsLikesEvalStub(SailRecEvaluatorRepository evaluatorRepository) {

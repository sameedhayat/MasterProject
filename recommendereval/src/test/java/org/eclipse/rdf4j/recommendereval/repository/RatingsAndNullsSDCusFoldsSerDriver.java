...
import org.eclipse.rdf4j.recommendereval.evaluator.crosskfold.CusFoldsRatingsAndNullsEvalStub;
 ...
 * @org.eclipse.rdf4j.recommender.repository.SrrRatingsAndNullsDriver.
 * 
 * This evaluator should be only used for test purposes.
 */
public class RatingsAndNullsSDCusFoldsSerDriver extends SailRecEvaluatorRepository {
     ...
     */
    public RatingsAndNullsSDCusFoldsSerDriver(Sail sail) {
        super(sail, new ArrayList<RecConfig>());
        this.recConfigList = EvalTestRepositoryInstantiator.getRecConfigListRatingsSDFixed();
    }
     ...
     * CusFoldsRatingsAndNullsEvalStub, that creates a SrrRatingsAndNullsDriver,
    ...
    public void loadEvalConfiguration(EvalConfig evalConfig)
        ...
        if (success) {
            ...
            if( evalConfig instanceof CrossKFoldEvalConfig ) {
                evaluator = new CusFoldsRatingsAndNullsEvalStub(this);
            }
            else {

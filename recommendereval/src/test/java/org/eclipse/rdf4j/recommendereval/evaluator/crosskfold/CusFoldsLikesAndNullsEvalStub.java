 ...
 */
public class CusFoldsLikesAndNullsEvalStub extends CrossKFoldEvaluator {

    final static Logger LOGGER = Logger.getLogger(CusFoldsLikesAndNullsEvalStub.class);
    
    public CusFoldsLikesAndNullsEvalStub(SailRecEvaluatorRepository evaluatorRepository) {
     ...
     * Note that user 4 is excluded because he has less ratings than the number
     * of folds (3).
     * 
     * @param numberOfFolds
     * @return 
    ...
    public Folds splitRatingsKFold(int numberOfFolds) 
            ...
            fold1OfUser1.add(new Rating("http://example.org/fixed#User1", "http://example.org/fixed#Item1", 1.0));
            fold1OfUser2.add(new Rating("http://example.org/fixed#User2", "http://example.org/fixed#Item3", 1.0));
            fold1OfUser3.add(new Rating("http://example.org/fixed#User3", "http://example.org/fixed#Item5", 1.0));
            
            fold2OfUser1.add(new Rating("http://example.org/fixed#User1", "http://example.org/fixed#Item4", 1.0));            
            fold2OfUser2.add(new Rating("http://example.org/fixed#User2", "http://example.org/fixed#Item5", 1.0));
            fold2OfUser3.add(new Rating("http://example.org/fixed#User3", "http://example.org/fixed#Item1", 1.0));
            fold2OfUser3.add(new Rating("http://example.org/fixed#User3", "http://example.org/fixed#Item2", 1.0));
            
            fold3OfUser1.add(new Rating("http://example.org/fixed#User1", "http://example.org/fixed#Item5", 1.0));
            fold3OfUser1.add(new Rating("http://example.org/fixed#User1", "http://example.org/fixed#Item6", 1.0));            
            fold3OfUser2.add(new Rating("http://example.org/fixed#User2", "http://example.org/fixed#Item1", 1.0));
            fold3OfUser3.add(new Rating("http://example.org/fixed#User3", "http://example.org/fixed#Item4", 1.0));

...
import org.eclipse.rdf4j.recommendereval.evaluator.crosskfold.CusFoldsLikesAndNullsEvalStub;
 ...
 * @org.eclipse.rdf4j.recommender.repository.LikesAndNullsSrrDriver.
 * 
 * This evaluator should be only used for test purposes.
 */
public class LikesAndNullsSDCusFoldsSerDriver extends SailRecEvaluatorRepository {
     ...
     */
    public LikesAndNullsSDCusFoldsSerDriver(Sail sail) {
        super(sail, new ArrayList<RecConfig>());
        this.recConfigList = EvalTestRepositoryInstantiator.getRecConfigListLikesSDFixed();
    }
     ...
     * CusFoldsLikesAndNullsEvalStub, that creates a SrrLikesAndNullsDriver,
    ...
    public void loadEvalConfiguration(EvalConfig evalConfig)
        ...
        if (success) {
            ...
            if( evalConfig instanceof CrossKFoldEvalConfig ) {
                evaluator = new CusFoldsLikesAndNullsEvalStub(this);
            }
            else {

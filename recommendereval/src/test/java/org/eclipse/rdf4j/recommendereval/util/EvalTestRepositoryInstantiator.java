...
public final class EvalTestRepositoryInstantiator {
    ...
    /**
     * Creates a list of Recommender Configurations, only use Rdf2VecEmbedding
     * 
     * Dataset: Cross Domain - Likes 
     *
     * @return recommender configuration list
     */
    public static ArrayList<RecConfig> getRecConfigListHybridOnlyRdf2Vec() {
...
//            configuration.computeUserEmbeddings("user_embeddings.csv");
    ...
    /**
     * Creates a list of Recommender Configurations, only using Doc2Vec embedding
     * 
     * Dataset: Cross Domain - Likes 
     *
     * @return recommender configuration list
     */
    public static ArrayList<RecConfig> getRecConfigListHybridOnlyDoc2Vec() {

 ...
 */
public class CusFoldsRatingsEvalStub extends CrossKFoldEvaluator {

    final static Logger LOGGER = Logger.getLogger(CusFoldsRatingsEvalStub.class);
    
    public CusFoldsRatingsEvalStub(SailRecEvaluatorRepository evaluatorRepository) {
 ...
 RatingsSrrDriver.
    ...
    public SailRecommenderRepository loadSail() {
        return new RatingsSrrDriver(new MemoryStore());
    }

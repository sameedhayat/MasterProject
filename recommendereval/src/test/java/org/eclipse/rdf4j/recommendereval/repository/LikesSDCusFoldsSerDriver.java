...
import org.eclipse.rdf4j.recommendereval.evaluator.crosskfold.CusFoldsLikesEvalStub;
 ...
 */
public class LikesSDCusFoldsSerDriver extends SailRecEvaluatorRepository {
     ...
     */
    public LikesSDCusFoldsSerDriver(Sail sail) {
     ...
     * CusFoldsLikesEvalStub, that creates a SrrLikesDriver,
    ...
    public void loadEvalConfiguration(EvalConfig evalConfig)
        ...
        if (success) {
            ...
            if( evalConfig instanceof CrossKFoldEvalConfig ) {
                evaluator = new CusFoldsLikesEvalStub(this);
            }
            else {

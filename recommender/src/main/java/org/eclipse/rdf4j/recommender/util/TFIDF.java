...
public class TFIDF {
    ...
    /**
     * @param Apply TFIDF on all the elements in the List
     * @param docs all documents
     * @return Map of terms with TF-IDF score
     */
    public Map<String, Double> allTfIdf(List<String> doc) {
    	
    	Map<String, Double> ret = new HashMap<String, Double>();
    	for(String token : doc){	
			double source_tfidf_score = tfIdf(doc, token);
			ret.put(token, source_tfidf_score);
		}

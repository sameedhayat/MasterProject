...
import org.eclipse.rdf4j.recommender.storage.index.invlist.AbstractInvListBasedStorage;

/**
 * The class is a concrete implementation of an index based storage based on
 * inverted lists which supports the storage of neighborhoods for collaborative
 * approaches.
 */
public class CfInvListBasedStorage extends AbstractInvListBasedStorage implements CfIndexBasedStorage{
